...
This guide describes how to build ratatoskrd, command-line utilities, and GUI on NetBSD.

**This guide has not been tested for building Ratatoskr Core and may fail. Please report your results; contributions welcome.**
...
It is not necessary to build wallet functionality to run ratatoskrd or the GUI.
...
Ratatoskr Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure Ratatoskr Core. Here is an example that
