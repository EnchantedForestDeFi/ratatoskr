...
Assumeutxo is a feature that allows fast bootstrapping of a validating ratatoskrd
...
considered active. This is the "traditional" mode of operation for ratatoskrd.
...
**Failure consideration:** if ratatoskrd unexpectedly halts after `m_stop_use` is set on
...
When ratatoskrd initializes again, what began as the snapshot chainstate is now
