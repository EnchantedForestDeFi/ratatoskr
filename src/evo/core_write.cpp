...
const std::map<std::string, RPCResult> RPCRESULT_MAP{{
    ...
    RESULT_MAP_ENTRY("collateralAddress", RPCResult::Type::STR, "Ratatoskr address used for collateral"),
    ...
    RESULT_MAP_ENTRY("operatorPayoutAddress", RPCResult::Type::STR, "Ratatoskr address used for operator reward payments"),
    ...
    RESULT_MAP_ENTRY("ownerAddress", RPCResult::Type::STR, "Ratatoskr address used for payee updates and proposal voting"),
    RESULT_MAP_ENTRY("payoutAddress", RPCResult::Type::STR, "Ratatoskr address used for masternode reward payments"),
    ...
    RESULT_MAP_ENTRY("votingAddress", RPCResult::Type::STR, "Ratatoskr address used for voting"),
}};
...
RPCResult CAssetLockPayload::GetJsonHelp(const std::string& key, bool optional)
{
    return {RPCResult::Type::OBJ, key, optional, key.empty() ? "" : "The asset lock special transaction",
    {
        ...
        {RPCResult::Type::ARR, "creditOutputs", "", {
            {RPCResult::Type::OBJ, "", "", {
                {RPCResult::Type::NUM, "value", "The value in RATR"},
